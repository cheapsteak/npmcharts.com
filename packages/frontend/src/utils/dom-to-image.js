...
/**
 * originally copied from https://github.com/tsayen/dom-to-image/blob/master/src/dom-to-image.js
 * There was no option to disable embedding fonts, which contribute a _huge_ amount to 
 * the exported file's size; it also wasn't only embed fonts that were used, but all 
 * fonts that exist (including ones used by chrome extensions)
*/
